        ...
        <div class="card shadow-sm border-0 rounded-4 mx-auto" style="max-width: 900px;">
            ...
            <div class="card-body p-4 p-md-5">
                ...
                <div class="alert alert-danger" role="alert">
                    ...
                    <p>Você está prestes a excluir permanentemente o registro listado abaixo. Esta ação não pode ser
                        desfeita.</p>
                </div>
            ...
            <div class="card-footer bg-white p-4 p-md-5 border-0 rounded-bottom-4">
                <form method="POST" action="{{ route('deletar_produto') }}">
                    ...
                    <div class="row g-3 justify-content-center">
                        ...
                        <div class="col-auto">
                            <input type="text" name="inputCodigo" id="inputCodigo"
                                class="form-control form-control-lg rounded-3 @error('inputCodigo') is-invalid @enderror"
                                style="width: 150px; text-align: center;" placeholder="{{ $codigo }}" autocomplete="off"
