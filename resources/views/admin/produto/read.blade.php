        ...
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
            ...
            <div class="d-flex justify-content-end gap-2 mt-3 mt-md-0">
                ...
                <a href="{{ route('produto_deletar', ['id' => $produto->id]) }}"
                    ...
                    style="width: 42px; height: 42px;" title="Excluir"> {{-- Adiciona confirmação
                    --}}
                            ...
                            <div class="col-6 col-md-4">
                                <div class="rounded border shadow-sm p-1">
                                    @if(Str::startsWith($media->file_type, 'image/'))
                                        <img src="{{ $media->getDir() }}" alt="Imagem do produto" class="img-fluid rounded"
            ...
            <div class="col-lg-6">
                <div class="card shadow-sm border-0 rounded-4 h-100">
                    <div class="card-body p-4 p-lg-5">
                        ...
                        @if(isset($produto->ofertas))
                            <h3 class="h4 text-success mb-3" style="font-size: 1.5rem; font-weight: 300;">
                                R$ {{ number_format($produto->preco(), 2, ',', '.') }}
                            </h3>
                        @endif
                        <h5 class="mb-4">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex justify-content-between px-0">
                                <strong>Tamanho(s)</strong>

                                <span>
                                    @forelse ($produto->tamanhos as $tamanho)
                                        {{ $tamanho->tamanho }}@if(!$loop->last), @endif
                                    @empty
                                        N/A
                                    @endforelse
                                </span>
                            ...
                            <li class="list-group-item d-flex justify-content-between px-0">
                                ...
                                <span>{{ $produto->subCategoria->descricao }}</span>
                            </li>
