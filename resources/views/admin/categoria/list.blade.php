        ...
        <div class="card shadow-sm border-0 rounded-4">
            ...
            <div class="card-header bg-white py-3 px-4 border-0 rounded-top-4">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ Route('categoria_cadastro') }}" class="btn btn-primary btn-lg rounded-pill px-4">
                                ...
                                <tr>
                                    ...
                                    <td class="px-4">
                                        <div class="d-flex justify-content-end gap-2">
                                            ...
                                            <a href="{{ route('categoria_edicao', ['id' => $categoria->id]) }}"
                                            ...
                                            <a href="{{ route('categoria_deletar', ['id' => $categoria->id]) }}"
